...
def read_MAL_pages(file_or_db = 'db', write_individual_entry = True, write_aggregated_entry = True, verbose = False):
    showcount = 0
        ...
        for anime_URL in gap.data:
            try:
                ...
                if file_or_db == 'file':
                    ...
                    anime.write_to_db(show_list_db, show_list_db, write_individual_entry, write_aggregated_entry)
                if verbose:
...
read_MAL_pages(write_individual_entry = True, write_aggregated_entry = False, verbose = True)
