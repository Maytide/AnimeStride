...
def read_MAL_pages(file_or_db = 'db', write_individual_entry = True, write_aggregated_entry = True, start_point = 0, verbose = False, test_mode = False):
    showcount = 0
    flag = False
...
read_MAL_pages(write_individual_entry = False, write_aggregated_entry = True, start_point = 0, verbose = True)
