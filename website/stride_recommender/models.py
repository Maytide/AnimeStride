...
class ContentData(models.Model):
    ...
    episodes = models.TextField(default='', blank=True, null=True)
    aired = models.TextField(default='', blank=True, null=True)
    ...
    score = models.TextField(default='', blank=True, null=True)
    ranked = models.TextField(default='', blank=True, null=True)
    members = models.TextField(default='', blank=True, null=True)
    popularity = models.TextField(default='', blank=True, null=True)
    favourites = models.TextField(default='', blank=True, null=True)
